...
class NewGameEnvironment {
	...
	public NewGameEnvironment() {
		
	}
	
	public void lauchSetup() {
		SetupWindow.main(null);
	}
	 public static void main(String[] args) {
//		 	new SetupWindow();
		 	NewGameEnvironment e = new NewGameEnvironment();
		 	//e.lauchSetup();
	    	Scanner input = new Scanner(System.in);
	    	e.outpost.setItemsForSale();
	    	e.days = e.getNumOfDays(input);
	    	e.crew1.setDays(e.days);
	    	e.requiredPieces = e.days * 2/3;
	    	e.crew1.setCrewMemberList(e.getCrewList(input));
	    	e.getShipName();
	    	 ...
	    	 */
	    	while (e.crew1.getNumPieces() < e.requiredPieces) {
	        	...
	        	int number = e.getValidInput(e.input0, 1, 10, question);
	        	if (number == 1) {
	        		for (CrewMember member: e.crew1.getCrewMemberList()) {
	        			member.viewStatus();
	        		}	
	        	}
		...
		private String getInput() {						// so can have more than 1 word in input 
		    Scanner input = new Scanner(System.in);
