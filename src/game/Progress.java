...
class Progress {
    ...
    public static void main(String[] args) {
    	...
    	while (crew1.getNumPieces() < requiredPieces) {
        	...
        	if (number == 3) {
        		visitNearestOutpost(crew1, outpost, leaveOutPost, input0);
        	/*
	...
	public static int getNumOfDays(Scanner input) {
		...
		do {
			...
			try {
				...
				System.out.println("You need to enter a Integer between 3 and 10");
				input.next();
			}
		}
	...
	public static void visitNearestOutpost(Crew crew1, SpaceOutpost outpost, boolean leaveOutPost, Scanner input0) {
