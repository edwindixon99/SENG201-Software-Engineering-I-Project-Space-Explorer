...
package game;
/**
 * This is the class for crew members that are of type 3. This class extends the CrewMember class.
 *
 * @author Jerome Grubb, Edwin Dixon
 * @version 16/05/19
 */
public class Type3 extends CrewMember {
	/**
	 * This is a constructor for Type3. This sets the name, along with the hunger, health and tiredness degrade for the crew members of type 3.
	 * 
	 ...
	 */
	public Type3(String name, int hungerDegrade,int healthDegrade, int tirednessDegrade) {
		setName(name);
